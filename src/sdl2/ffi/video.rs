...
pub struct SDL_DisplayMode {
    pub format: Uint32,            // pixel format
    pub w: c_int,                  // width
    pub h: c_int,                  // height
    pub refresh_rate: c_int,       // refresh rate (or zero for unspecified)
    pub driverdata: *c_void,       // driver-specific data, initialize to 0
}

pub enum SDL_Window {}

// SDL does not specify the size of SDL_WindowFlags, but this was found using
...
// }
// fn main() {
//     println!("{}", std::mem::size_of::<SDL_WindowFlags>()); // prints "4"
// }
// ~~~
bitflags!(flags SDL_WindowFlags: Uint32 {
    ...
    static SDL_WINDOW_FULLSCREEN_DESKTOP   = SDL_WINDOW_FULLSCREEN.bits | 0x00001000,
...
// SDL does not specify the size of SDL_GLcontextFlag, but this was found using
// the following program:
//
// ~~~
// #[repr(C)]
...
// 
// fn main() {
//     println!("{}", std::mem::size_of::<SDL_GLcontextFlag>()); // prints "4"
// }
// ~~~
bitflags!(flags SDL_GLcontextFlag: Uint32 {
